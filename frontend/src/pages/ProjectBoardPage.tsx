...
import {
  formatTaskAuditAction,
  formatTaskAuditFieldName,
  formatTaskAuditValue,
} from '../lib/taskAudit';
...
export function ProjectBoardPage() {
  ...
  const deleteTask = useMutation({
    mutationFn: (id: string) =>
        taskService.remove(projectId, id),
  ...
  return (
      <div className="app-shell">
        ...
        <main className="board-page">
          ...
          {historyTask && (
              <Modal
                  title={`Histórico — ${historyTask.title}`}
                  onClose={() =>
                      setHistoryTask(null)
                  }
                  wide
